# 1 "AECUL_Modules/LCD/ecu_chr_lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "AECUL_Modules/LCD/ecu_chr_lcd.c" 2
...
# 12 "AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h"
...
# 12 "AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "AECUL_Modules/LCD/../../MCAL/GPIO/../../std_Types.h" 1
# 11 "AECUL_Modules/LCD/../../MCAL/GPIO/../../std_Types.h"
...
# 11 "AECUL_Modules/LCD/../../MCAL/GPIO/../../std_Types.h" 2
...
# 15 "AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h" 2
...
# 1 "AECUL_Modules/LCD/../../mcc_generated_files/system/clock.h" 1
# 50 "AECUL_Modules/LCD/../../mcc_generated_files/system/clock.h"
void CLOCK_Initialize(void);
# 13 "AECUL_Modules/LCD/ecu_chr_lcd.h" 2
...
# 8 "AECUL_Modules/LCD/ecu_chr_lcd.c" 2


static uint8_t lcd_send_4bits(const chr_lcd_4bit_t *lcd, uint8_t _data_command);
static uint8_t lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd);
static uint8_t lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8_t row, uint8_t coulmn);
static uint8_t lcd_8bit_send_enable_signal(const chr_lcd_8bit_t *lcd);
static uint8_t lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8_t row, uint8_t coulmn);
# 23 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_4bit_intialize(const chr_lcd_4bit_t *lcd){
    uint8_t ret = 1;
...
# 60 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_4bit_send_command(const chr_lcd_4bit_t *lcd, uint8_t command){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 89 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_4bit_send_char_data(const chr_lcd_4bit_t *lcd, uint8_t data){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 120 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd,uint8_t row, uint8_t column, uint8_t data){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 140 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_4bit_send_string(const chr_lcd_4bit_t *lcd, uint8_t *str){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 163 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd, uint8_t row, uint8_t column, uint8_t *str){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 188 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8_t row, uint8_t column,
                                         const uint8_t _chr[], uint8_t mem_pos){
    uint8_t ret = 1;
...
# 212 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_8bit_intialize(const chr_lcd_8bit_t *lcd){
    uint8_t ret = 1;
    uint8_t l_data_pins_counter = 0;
    if((0) == lcd){
...
# 249 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_8bit_send_command(const chr_lcd_8bit_t *lcd, uint8_t command){
    uint8_t ret = 1;
    uint8_t l_pin_counter = 0;
    if((0) == lcd){
        ret = 0;
    }
    else{
        ...
        for(l_pin_counter=0; l_pin_counter<8; ++l_pin_counter){
            ret = gpio_pin_write_logic(&(lcd->lcd_data[l_pin_counter]), (command >> l_pin_counter) & (uint8_t)0x01);
        }
...
# 277 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8_t data){
    uint8_t ret = 1;
    uint8_t l_pin_counter = 0;
    if((0) == lcd){
        ...
        for(l_pin_counter=0; l_pin_counter<8; ++l_pin_counter){
            ret = gpio_pin_write_logic(&(lcd->lcd_data[l_pin_counter]), (data >> l_pin_counter) & (uint8_t)0x01);
        }
...
# 307 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd,uint8_t row, uint8_t column, uint8_t data){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 327 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_8bit_send_string(const chr_lcd_8bit_t *lcd, uint8_t *str){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 350 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd, uint8_t row, uint8_t column, uint8_t *str){
    uint8_t ret = 1;
    if((0) == lcd){
        ret = 0;
...
# 373 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8_t row, uint8_t column,
                                         const uint8_t _chr[], uint8_t mem_pos){
    uint8_t ret = 1;
    uint8_t lcd_counter = 0;
...
# 398 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t convert_uint8_to_string(uint8_t value, uint8_t *str){
    uint8_t ret = 1;
    if((0) == str){
        ret = 0;
...
# 418 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t convert_uint16_to_string(uint16_t value, uint8_t *str){
    uint8_t ret = 1;
...
# 445 "AECUL_Modules/LCD/ecu_chr_lcd.c"
uint8_t convert_uint32_to_string(uint32_t value, uint8_t *str){
    uint8_t ret = 1;
    if((0) == str){
        ret = 0;
...
# 465 "AECUL_Modules/LCD/ecu_chr_lcd.c"
static uint8_t lcd_send_4bits(const chr_lcd_4bit_t *lcd, uint8_t _data_command){
    uint8_t ret = 1;
    ret = gpio_pin_write_logic(&(lcd->lcd_data[0]), (_data_command >> 0) & (uint8_t)0x01);
    ret = gpio_pin_write_logic(&(lcd->lcd_data[1]), (_data_command >> 1) & (uint8_t)0x01);
    ret = gpio_pin_write_logic(&(lcd->lcd_data[2]), (_data_command >> 2) & (uint8_t)0x01);
    ret = gpio_pin_write_logic(&(lcd->lcd_data[3]), (_data_command >> 3) & (uint8_t)0x01);
    return ret;
}
# 481 "AECUL_Modules/LCD/ecu_chr_lcd.c"
static uint8_t lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd){
    uint8_t ret = 1;
...
# 496 "AECUL_Modules/LCD/ecu_chr_lcd.c"
static uint8_t lcd_8bit_send_enable_signal(const chr_lcd_8bit_t *lcd){
    uint8_t ret = 1;
    ret = gpio_pin_write_logic(&(lcd->lcd_en), GPIO_HIGH);
    _delay((unsigned long)((5)*(16000000/4000000.0)));
...
# 513 "AECUL_Modules/LCD/ecu_chr_lcd.c"
static uint8_t lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8_t row, uint8_t coulmn){
    uint8_t ret = 1;
    coulmn--;
    switch(row){
...
# 535 "AECUL_Modules/LCD/ecu_chr_lcd.c"
static uint8_t lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8_t row, uint8_t coulmn){
    uint8_t ret = 1;
    coulmn--;
    switch(row){
