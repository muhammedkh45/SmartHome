...
# 37 "./mcc_generated_files/system/../uart/eusart.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c90\\stdbool.h" 1 3
# 37 "./mcc_generated_files/system/../uart/eusart.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c90\\stdint.h" 1 3
# 38 "./mcc_generated_files/system/../uart/eusart.h" 2
...
# 52 "./mcc_generated_files/system/../uart/uart_types.h"
...
# 55 "./mcc_generated_files/system/../uart/uart_drv_interface.h"
typedef struct {
...
# 106 "./mcc_generated_files/system/../uart/eusart.h"
...
# 165 "./mcc_generated_files/system/../uart/eusart.h"
...
# 182 "./mcc_generated_files/system/../uart/eusart.h"
...
# 231 "./mcc_generated_files/system/../uart/eusart.h"
...
# 267 "./mcc_generated_files/system/../uart/eusart.h"
uint8_t EUSART_Read(void);
# 277 "./mcc_generated_files/system/../uart/eusart.h"
...
# 55 "./mcc_generated_files/system/../i2c_host/mssp.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c90\\stdint.h" 1 3
# 55 "./mcc_generated_files/system/../i2c_host/mssp.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c90\\stdbool.h" 1 3
# 56 "./mcc_generated_files/system/../i2c_host/mssp.h" 2
...
# 101 "./mcc_generated_files/system/../i2c_host/mssp.h"
i2c_error_t I2C_Open(i2c_address_t address);
# 111 "./mcc_generated_files/system/../i2c_host/mssp.h"
i2c_error_t I2C_Close(void);
# 123 "./mcc_generated_files/system/../i2c_host/mssp.h"
...
# 142 "./mcc_generated_files/system/../i2c_host/mssp.h"
void I2C_SetTimeout(uint8_t timeOut);
# 152 "./mcc_generated_files/system/../i2c_host/mssp.h"
void I2C_SetBuffer(void *buffer, size_t bufferSize);
# 164 "./mcc_generated_files/system/../i2c_host/mssp.h"
void I2C_SetDataCompleteCallback(i2c_callback_t cb, void *ptr);
# 174 "./mcc_generated_files/system/../i2c_host/mssp.h"
...
# 213 "./mcc_generated_files/system/../i2c_host/mssp.h"
void (*MSSP_InterruptHandler)(void);
# 222 "./mcc_generated_files/system/../i2c_host/mssp.h"
...
# 37 "./mcc_generated_files/system/../nvm/nvm.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c90\\stdbool.h" 1 3
# 37 "./mcc_generated_files/system/../nvm/nvm.h" 2
...
# 10 "./AECUL_Modules/EEPROM_24C02C/EPROM_24C02C.h"
...
# 15 "./AECUL_Modules/TemSensor_TC74/TemSensor_TC74.h"
uint8_t TemSensor_TC74_Read_Temp (i2c_address_t Temp_Address);
# 16 "./Application.h" 2

# 1 "./AECUL_Modules/Keypad/KeyPad.h" 1
# 12 "./AECUL_Modules/Keypad/KeyPad.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c90\\stdint.h" 1 3
# 12 "./AECUL_Modules/Keypad/KeyPad.h" 2
...
# 1 "./AECUL_Modules/LCD/ecu_chr_lcd_cfg.h" 1
# 10 "./AECUL_Modules/LCD/ecu_chr_lcd_cfg.h"
# 1 "./AECUL_Modules/LCD/ecu_chr_lcd.h" 1
# 12 "./AECUL_Modules/LCD/ecu_chr_lcd.h"
# 1 "./AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h" 1
# 13 "./AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h"
# 1 "./AECUL_Modules/LCD/../../MCAL/GPIO/../../std_Types.h" 1
# 13 "./AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c90\\stdint.h" 1 3
# 14 "./AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h" 2


# 1 "./AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio_cfg.h" 1
# 16 "./AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h" 2
# 38 "./AECUL_Modules/LCD/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
uint8_t gpio_pin_direction_intialize(const pin_config_t *_pin_config);
uint8_t gpio_pin_get_direction_status(const pin_config_t *_pin_config, direction_t *direction_status);
uint8_t gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t logic);
uint8_t gpio_pin_read_logic(const pin_config_t *_pin_config, logic_t *logic);
uint8_t gpio_pin_toggle_logic(const pin_config_t *_pin_config);
uint8_t gpio_pin_intialize(const pin_config_t *_pin_config);

uint8_t gpio_port_direction_intialize(port_index_t port, uint8_t direction);
uint8_t gpio_port_get_direction_status(port_index_t port, uint8_t *direction_status);
uint8_t gpio_port_write_logic(port_index_t port, uint8_t logic);
uint8_t gpio_port_read_logic(port_index_t port, uint8_t *logic);
uint8_t gpio_port_toggle_logic(port_index_t port);
# 12 "./AECUL_Modules/LCD/ecu_chr_lcd.h" 2
# 46 "./AECUL_Modules/LCD/ecu_chr_lcd.h"
typedef struct{
    pin_config_t lcd_rs;
    pin_config_t lcd_en;
...
uint8_t lcd_4bit_intialize(const chr_lcd_4bit_t *lcd);
uint8_t lcd_4bit_send_command(const chr_lcd_4bit_t *lcd, uint8_t command);
uint8_t lcd_4bit_send_char_data(const chr_lcd_4bit_t *lcd, uint8_t data);
uint8_t lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd,uint8_t row, uint8_t column, uint8_t data);
uint8_t lcd_4bit_send_string(const chr_lcd_4bit_t *lcd, uint8_t *str);
uint8_t lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd, uint8_t row, uint8_t column, uint8_t *str);
uint8_t lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8_t row, uint8_t column,
                                         const uint8_t _chr[], uint8_t mem_pos);

uint8_t lcd_8bit_intialize(const chr_lcd_8bit_t *lcd);
uint8_t lcd_8bit_send_command(const chr_lcd_8bit_t *lcd, uint8_t command);
uint8_t lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8_t data);
uint8_t lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd,uint8_t row, uint8_t column, uint8_t data);
uint8_t lcd_8bit_send_string(const chr_lcd_8bit_t *lcd, uint8_t *str);
uint8_t lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd, uint8_t row, uint8_t column, uint8_t *str);
uint8_t lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8_t row, uint8_t column,
                                         const uint8_t _chr[], uint8_t mem_pos);

uint8_t convert_uint8_to_string(uint8_t value, uint8_t *str);
uint8_t convert_uint16_to_string(uint16_t value, uint8_t *str);
uint8_t convert_uint32_to_string(uint32_t value, uint8_t *str);
# 10 "./AECUL_Modules/LCD/ecu_chr_lcd_cfg.h" 2
...
int main(void)
{
    ...
    ret = lcd_8bit_send_command(&LCD_1,0x0C);
    keyPad_Init();
    ...
    while(1)
    {
        Temp_A7_Val = TemSensor_TC74_Read_Temp(0x9E);
